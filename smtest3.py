...
write_providers(f,"SMTest3","SMTest3","SecurManage Test Provider", now_out, now_out)
...
for row in reader:
	...
	f.write("\t\t\t\t<active>true</active>\n") 
		#here here here  What EE type will we use?
	f.write("\t\t\t\t<typeEntryExit>HUD</typeEntryExit>\n")
	f.write("\t\t\t\t<client>" + cId + "</client>\n")
		#here here here   Don't hard code the provider
	f.write("\t\t\t\t<provider>SMTest3</provider>\n") 
